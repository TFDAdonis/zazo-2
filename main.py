...
if not st.session_state.google_credentials:
    ...
    <style>
        ...
        .login-container::before {
            ...
            background: 
                ...
                radial-gradient(circle at 80% 20%, rgba(0, 204, 106, 0.12) 0%, transparent 50%),
    ...
    if google_config:
        try:
            ...
            <div class="login-features">
                <div class="feature-item">
                    ...
                    <div class="feature-text">Satellite Imagery</div>
                </div>
                <div class="feature-item">
                    <div class="feature-icon">🌳</div>
                    <div class="feature-text">Vegetation Analysis</div>
                </div>
                <div class="feature-item">
                    <div class="feature-icon">📊</div>
                    <div class="feature-text">3D Visualization</div>
                </div>
                <div class="feature-item">
                    <div class="feature-icon">⚡</div>
                    <div class="feature-text">Real-time Data</div>
                </div>
            </div>
            
            <div class="login-footer">
                <p style="color: #888888; margin-bottom: 15px;">
                    Powered by Google Earth Engine • NASA Satellites • Mapbox GL
                </p>
            ...
            st.markdown("""
            <div style="background: rgba(255, 87, 87, 0.1); border: 1px solid rgba(255, 87, 87, 0.3); 
                        border-radius: 12px; padding: 20px; margin-top: 20px;">
                <p style="color: #ff5757; margin: 0; font-weight: 500;">
                    Authentication configuration error. Please check your Google OAuth setup.
                </p>
            </div>
            """, unsafe_allow_html=True)
    else:
        ...
        <div style="background: rgba(255, 87, 87, 0.1); border: 1px solid rgba(255, 87, 87, 0.3); 
                    border-radius: 12px; padding: 20px; margin-top: 20px;">
            <p style="color: #ff5757; margin: 0; font-weight: 500;">
                Configuration required. Please check your Google OAuth setup in Streamlit secrets or client_secret.json
            </p>
        </div>
        """, unsafe_allow_html=True)
